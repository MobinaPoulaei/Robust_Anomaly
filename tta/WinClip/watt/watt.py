...
class WATT:
    ...
    def __init__(self, base_model, lr, type='sequential', l=2, m=5, temps_dir='templates.yaml', ref_eval=False,
                 device='cpu'):
        """
        ...
        for m in range(self.m):
            ...
            for text_feat in text_x:
                if self.type == 'parallel':
                    if m == 0:
                        self.load_model_and_optimizer(self.model, self.optimizer, self.model_state,
