...
class MIADSolver(object):
    CLSNAMES = ['photovoltaic_module', 'wind_turbine']

    def __init__(self, root='/kaggle/working/miad'):
        self.root = root
...
if __name__ == '__main__':
    runner = MIADSolver(root='/home/haghifam/Datasets/MIAD')  # Adjusted to your path
    runner.run()