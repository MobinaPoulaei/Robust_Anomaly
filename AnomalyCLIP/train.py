...
def train(args):
  ...
  ##########################################################################################
    classnames = ['metal_nut']#get_classnames(args.train_data_path)
    prompt_learner = AnomalyCLIP_PromptLearner(model.to("cpu"), AnomalyCLIP_parameters, _classnames=classnames)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_data_path", type=str, default="/home/haghifam/HDD1/mvtec-ad", help="train dataset path")
    parser.add_argument("--save_path", type=str, default='./checkpoint/mvtec', help='path to save results')
